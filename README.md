...
## Naming
Each file name ends with 3-letter code that has contains information about the file. The order of the letters is `Display-Color`, `Background-Color`, and `File Size`. 
